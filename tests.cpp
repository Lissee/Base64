...
TEST(out, outputs){
    ...
    string inp_2 = "QSB2aSBwb3N0YXZpdGUgbW5lIHphY2hldD86KQ==";

    testing::internal::CaptureStdout();
     Decodding(Base64Table, inp_2);
    EXPECT_EQ(testing::internal::GetCapturedStdout(), "A vi postavite mne zachet?:)");


    string inp_3 = "MS4gQ3JvY29kaWxlIGlzIGxvbmdlciB0aGFuIGdyZWVuIFByb29mOiBjcm9jb2RpbGUgaXMgbG9uZyBib3RoIG9uIHRvcCBhbmQgYm90dG9tLCBhbmQgZ3JlZW4gaXMgb25seSBvbiB0b3Au)";
